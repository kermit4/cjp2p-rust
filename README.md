...
- add VSTs to DAW?
- mypublickey  can just override other peoples and DOS their ability to  receive messages .. maybe another cookie for the pub key?  or sign the existing cookie?
