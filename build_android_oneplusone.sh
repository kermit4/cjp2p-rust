#!/bin/bash
# Builds cjp2p as an Android APK that opens https://oneplusone.bzz.link/
# in the device's default browser (instead of the embedded WebView).
#
...
MAIN_JAVA="$ANDROID_DIR/app/src/main/java/com/cjp2p/MainActivity.java"
...
echo "=== Step 5b: Patching MainActivity to open oneplusone.bzz.link ==="
cp "$MAIN_JAVA" "${MAIN_JAVA}.bak"
...
public class MainActivity extends Activity {
    private static final String URL = "https://oneplusone.bzz.link/";
...
restore_main() {
    mv "${MAIN_JAVA}.bak" "$MAIN_JAVA"
    echo "Restored MainActivity.java"
}
